...
if __name__ == '__main__':
    ...
    metric_precision = load_metric("mymetrics/precision.py")
    metric_recall = load_metric("mymetrics/recall.py")
    metric_f1 = load_metric("mymetrics/f1.py")
    metric_accuracy = load_metric("mymetrics/accuracy.py")
